  ...
  return (
    <div className="bg-[url('/hero-bg-1.png')] w-full bg-cover bg-center">
      <div className="py-7 mx-4 sm:mx-8 md:mx-36 flex flex-col justify-center">
        ...
        <div className="mt-4 p-4 sm:p-5 bg-white/20 flex flex-col md:flex-row w-full rounded-4xl">
          <div className="w-full md:w-7/12 px-4 sm:px-8 md:px-15 text-white">
            <h3 className="text-xl sm:text-2xl md:text-3xl text-center font-extrabold">Welcome to Alaimagal Hotels</h3>
            <h6 className="text-lg sm:text-xl md:text-xl text-center font-semibold">A Taste of Tradition</h6>

            <div className="flex flex-col pt-5 space-y-4 text-base sm:text-lg md:text-lg text-justify">
              <p>
            ...
            <div className="flex flex-col space-y-1 pt-5">
              <h3 className="text-center text-lg sm:text-xl md:text-xl font-bold">Alaimagal Hotels</h3>
              <p className="text-center text-base sm:text-lg md:text-lg">where the taste of tradition lives on, every single day.</p>
            </div>
          </div>
          ...
          <div className="w-full md:w-5/12 justify-center items-center flex mt-4 md:mt-0">
            <img
              ...
              className="w-[200px] sm:w-[300px] md:w-[380px]"
            />
          </div>
        </div>
      </div>
