    ...
    <div className=''>
      <div className='relative w-full flex'>
        ...
        <div className="bg-[url('/hero-bg-1.png')]  w-full h-screen bg-cover bg-center rounded-br-[120]">
          <div className='pl-24'>
            {/* Hero Title */}
            <h1 className='text-4xl pt-[200] text-white font-extrabold py-12'>Authentic Non-Veg Delights.<br/> A Taste of Tradition.</h1>
            <h4 className='text-white text-2xl'>Rooted in heritage, perfected with passion <br/> 
      ...
      <div className='absolute top-24 right-0'>
        <img src='/hero-image.png' alt='' className='w-[850px] py-8' />
      </div>
    </div>
  )
}
